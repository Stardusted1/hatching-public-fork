...
class _$_AuthUser implements _AuthUser {
  _$_AuthUser({required this.id, required this.name});
  ...
  @override
  String toString() {
    return 'AuthUser(id: $id, name: $name)';
  }
...
abstract class _AuthUser implements AuthUser {
  factory _AuthUser({required final String id, required final String name}) =
      _$_AuthUser;
